...
class GPTModel(nn.Module):
    def __init__(self, cfg):
        ...
        self.max_context = cfg["context_length"]
    ...
    def forward(self, in_idx):
        ...
        assert seq_len <= self.max_context, "Context length exceeded"
...
def generate_text_simple(model, idx, max_new_tokens, context_size):
    ...
    for _ in range(max_new_tokens):
        ...
        # (batch, num_tokens, vocab_size) becomes (batch, vocab_size)
        logits = logits[:, -1, :]
        
        # Get the idx of the vocab entry with the hightest logits value
